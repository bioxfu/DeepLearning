...
class MiniGoogLeNet:
    ...
    def build(width, height, depth, classes):
        # initialzie the input shape to be "channels last" and the 
        ...
        # two Inception modules followd by a downsample module
        ...
        # two Inception modules followd by global POOL and dropout
